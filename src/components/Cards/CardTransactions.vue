 ...
 * @LastEditTime: 2022-06-14 13:36:22
 * @FilePath: \muse-vue-ant-design-dashboard\src\components\Cards\CardTransactions.vue
				...
				<a-list-item>
					...
					<template v-else>
						<a-list-item-meta :title="item.title" :description="item.datetime">
							<template #avatar>
								<a-avatar size="small" v-if="item.type == 1"
								...
								<a-avatar size="small" v-if="item.type == 0"
